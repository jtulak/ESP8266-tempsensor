...
#include "gpio16.h"
	...
	gpio16_output_conf(void){    WRITE_PERI_REG(PAD_XPD_DCDC_CONF,
...
void ICACHE_FLASH_ATTR
gpio16_output_set(uint8 value){    WRITE_PERI_REG(RTC_GPIO_OUT, (READ_PERI_REG(RTC_GPIO_OUT) & (uint32)0xfffffffe) | (uint32)(value & 1));}
